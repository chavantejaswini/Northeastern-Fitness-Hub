...
public class ManageNetworkJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("MANAGE NETWORK LOCATION");
        ...
        add(citySuccessLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 390, 50, 50));
        ...
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(-50, 50, 230, 140));
    }// </editor-fold>//GEN-END:initComponents

    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        if (cityValid) {
            String name = nameJTextField.getText();
            NetworkLocation network = system.createAndAddNetwork();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        NetworkLocation n = (NetworkLocation) networkJTable.getValueAt(row, 0);
