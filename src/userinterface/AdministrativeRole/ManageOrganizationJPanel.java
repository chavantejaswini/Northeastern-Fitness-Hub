...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo() {
        ...
        for (Type type : Organization.Type.values()) {
            if (ent.equals("Healthy Living Center")) {
                if (type.getValue().equals(Type.Nutrition.getValue())) {
                    organizationJComboBox.addItem(type);
                }
            } else if (ent.equals("Fitness Center")) {
            ...
            } else if (ent.equals("Healthcare Clinic")) {
    ...
    private void initComponents() {
        ...
        organizationJTable.setForeground(new java.awt.Color(0, 102, 102));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 150, 480, 120));
        ...
        enterpriseLabel.setText("Manage Firm");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 20, 270, 30));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fitlogo.jpeg"))); // NOI18N
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(-50, 50, 230, 130));
