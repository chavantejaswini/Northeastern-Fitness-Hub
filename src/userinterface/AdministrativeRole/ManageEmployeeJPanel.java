...
public class ManageEmployeeJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (organizationJTable.getColumnModel().getColumnCount() > 0) {
            organizationJTable.getColumnModel().getColumn(0).setMinWidth(50);
            organizationJTable.getColumnModel().getColumn(0).setMaxWidth(50);
            organizationJTable.getColumnModel().getColumn(1).setResizable(false);
            organizationJTable.getColumnModel().getColumn(2).setResizable(false);
        }

        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 230, 380, 170));
        ...
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 180, 190, 30));

        jLabel1.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel1.setText("Organization:");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 180, 78, 25));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, -1, 31));
        ...
        add(organizationEmpJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 150, 190, 30));

        jLabel3.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Organization:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 140, -1, 40));

        jLabel4.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText("Role:");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 200, 72, 40));
        ...
        add(roleJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 210, 190, 30));

        jLabel5.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Email ID:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 310, 60, 30));
        ...
        add(txtUserName, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 310, 190, 30));

        jLabel6.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("Password:");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 370, 70, 10));
        ...
        add(createUserJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 440, 87, 44));

        jLabel2.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 102, 102));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Add Employees");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 100, 302, 30));

        jLabel7.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 102, 102));
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText("View Employees");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 120, 370, 31));
        ...
        add(btnRemove, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 410, 113, 44));

        jLabel8.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Name:");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 260, 72, 30));
        ...
        add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 260, 190, 30));
        ...
        add(emailIDAlreadyLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 340, 160, 20));

        emailSuccessLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fittick.png"))); // NOI18N
        add(emailSuccessLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 300, 40, 50));
        ...
        add(emailLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 340, 150, 20));
        ...
        add(cityLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 290, 160, 20));

        citySuccessLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fittick.png"))); // NOI18N
        add(citySuccessLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 250, 50, 50));
        ...
        add(passwordLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 400, 160, 10));

        passwordSuccessLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fittick.png"))); // NOI18N
        add(passwordSuccessLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 360, 40, 30));

        jSeparator1.setOrientation(javax.swing.SwingConstants.VERTICAL);
        add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 130, -1, 410));
        ...
        add(passwordJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 360, 190, 30));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fitlogo.jpeg"))); // NOI18N
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 70, 240, 160));

        enterpriseLabel.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        enterpriseLabel.setForeground(new java.awt.Color(0, 102, 102));
        enterpriseLabel.setText("Manage Firm Employees");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 30, 360, 30));
