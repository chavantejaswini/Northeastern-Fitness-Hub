...
public class FitnessTrainerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public FitnessTrainerWorkAreaJPanel(JPanel userProcessContainer, Enterprise enterprise, Organization organization, UserAccount account, EcoSystem business, NetworkLocation network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 180, 675, 110));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 610, -1, 40));

        jLabel2.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("Name:");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 390, 107, 30));
        ...
        jLabel5.setText("Age:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 430, 90, 30));
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 470, 86, 30));
        ...
        add(txtHeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 470, 150, 30));

        jLabel8.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Weight (in Kgs):");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 510, -1, 30));
        ...
        add(txtWeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 510, 150, 30));
        ...
        add(viewDetailsBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 320, 138, 45));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 410, -1, -1));

        jLabel3.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Message:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 380, 80, 30));
        ...
        fitnessChartComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fitnessChartComboBoxActionPerformed(evt);
            }
        });
        add(fitnessChartComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 540, 150, 30));

        jLabel4.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText("Fitness Chart:");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 510, 80, 30));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fitlogo.jpeg"))); // NOI18N
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 50, 240, 130));
        ...
        viewMessageBtn.setBackground(new java.awt.Color(0, 102, 102));
        viewMessageBtn.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        viewMessageBtn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        add(viewMessageBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 320, 138, 45));
    ...
    public void sendEmail(String email, String chart) {
        final String password = "ketki";
        String fromEmail = "fitnesshub@gmail.com";
...
//            }
    ...
    private void fitnessChartComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fitnessChartComboBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fitnessChartComboBoxActionPerformed
