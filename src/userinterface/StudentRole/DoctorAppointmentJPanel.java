...
public class DoctorAppointmentJPanel extends javax.swing.JPanel {
    ...
    DoctorAppointmentJPanel(JPanel userProcessContainer, EcoSystem system, NetworkLocation network, UserAccount userAccount) {
        initComponents();
    ...
    private void initComponents() {
        ...
        generalBtn.setBackground(new java.awt.Color(0, 102, 102));
        generalBtn.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        generalBtn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        physioBtn.setBackground(new java.awt.Color(0, 102, 102));
        physioBtn.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        physioBtn.setForeground(new java.awt.Color(255, 255, 255));
