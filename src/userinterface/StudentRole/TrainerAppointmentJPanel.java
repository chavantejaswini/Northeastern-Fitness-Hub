...
public class TrainerAppointmentJPanel extends javax.swing.JPanel {
    ...
    TrainerAppointmentJPanel(JPanel userProcessContainer, EcoSystem system, NetworkLocation network, UserAccount userAccount) {
        initComponents();
    ...
    private void initComponents() {
        ...
        weightBtn.setForeground(new java.awt.Color(0, 102, 102));
        ...
        fitnessBtn.setForeground(new java.awt.Color(0, 102, 102));
