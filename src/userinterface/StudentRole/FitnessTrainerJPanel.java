...
import Business.Organization.OrgFitnessTraining;
...
public class FitnessTrainerJPanel extends javax.swing.JPanel {
    ...
    FitnessTrainerJPanel(JPanel userProcessContainer, EcoSystem system, NetworkLocation network, UserAccount userAccount) {
        initComponents();
    ...
    private void populateFitnessStatusTable() {
        ...
        for (Organization organization : e.getOrganizationDirectory().getOrganizationList()) {
            if (organization instanceof OrgFitnessTraining) {
                org = organization;
                break;
            }
        }
    ...
    private void initComponents() {
        ...
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(-40, -20, 220, 160));

        enterpriseLabel.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        enterpriseLabel.setForeground(new java.awt.Color(0, 102, 102));
        enterpriseLabel.setText("FITNESS TRAINER");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 60, 320, 30));
