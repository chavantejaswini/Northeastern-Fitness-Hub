...
public class GeneralPractitionerJPanel extends javax.swing.JPanel {
    ...
    GeneralPractitionerJPanel(JPanel userProcessContainer, EcoSystem system, NetworkLocation network, UserAccount userAccount) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 360, 50));

        jLabel5.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel5.setText("Enter Your Message:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 160, 170, 50));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 160, 155, 48));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, 820, 130));

        jLabel9.setForeground(new java.awt.Color(255, 51, 51));
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fitlogo.jpeg"))); // NOI18N
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, -20, 260, 180));

        enterpriseLabel.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        enterpriseLabel.setForeground(new java.awt.Color(0, 102, 102));
        enterpriseLabel.setText("GENERAL PRACTITIONER");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 30, 410, 30));
