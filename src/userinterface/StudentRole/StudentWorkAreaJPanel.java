...
public class StudentWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public StudentWorkAreaJPanel(JPanel userProcessContainer, Enterprise enterprise, Organization organization, UserAccount account, EcoSystem business, NetworkLocation network) {
        initComponents();
...
//        txtPassword.setText(userAccount.getPassword());
    ...
    private void initComponents() {
        ...
        fitLearnings = new javax.swing.JButton();
        fitnesschallenge = new javax.swing.JButton();
        ...
        btnAnalysis.setBackground(new java.awt.Color(0, 102, 102));
        ...
        nameSuccessLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fittick.png"))); // NOI18N
        add(nameSuccessLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 230, 30, -1));

        AgeSuccessLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fittick.png"))); // NOI18N
        ...
        heightSuccessLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fittick.png"))); // NOI18N
        add(heightSuccessLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 350, 30, -1));

        weightSuccessLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fittick.png"))); // NOI18N
        add(weightSuccessLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 390, 40, -1));

        addressSuccessLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fittick.png"))); // NOI18N
        add(addressSuccessLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 230, 40, -1));

        citySuccessLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fittick.png"))); // NOI18N
        add(citySuccessLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 270, 30, -1));

        zipSuccessLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fittick.png"))); // NOI18N
        ...
        passwordSuccessLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fittick.png"))); // NOI18N
        ...
        greetLbl.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fitlogo.jpeg"))); // NOI18N
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(-60, 40, 220, 150));

        fitLearnings.setBackground(new java.awt.Color(204, 204, 204));
        fitLearnings.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        fitLearnings.setForeground(new java.awt.Color(51, 51, 51));
        fitLearnings.setText("Fitness learnings");
        fitLearnings.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fitLearningsActionPerformed(evt);
            }
        });
        add(fitLearnings, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 490, 140, 51));

        fitnesschallenge.setBackground(new java.awt.Color(204, 204, 204));
        fitnesschallenge.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        fitnesschallenge.setForeground(new java.awt.Color(51, 51, 51));
        fitnesschallenge.setText("Fitness Challenges");
        fitnesschallenge.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fitnesschallengeActionPerformed(evt);
            }
        });
        add(fitnesschallenge, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 490, 140, 51));
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        // TODO add your handling code here:
        NetworkLocation network = (NetworkLocation) networkJComboBox.getSelectedItem();
...
//            radioFemale.setEnabled(false);
    ...
    private void fitLearningsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fitLearningsActionPerformed
        // TODO add your handling code here:
        fitLearningsForStuJPanel fitLerarn = new fitLearningsForStuJPanel(userProcessContainer, system);
        userProcessContainer.add("fitLearningsForStuJPanel", fitLerarn);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    }//GEN-LAST:event_fitLearningsActionPerformed

    private void fitnesschallengeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fitnesschallengeActionPerformed
         //fitnessChallengesStuJPanel
        fitnessChallengesStuJPanel fitchallenges = new fitnessChallengesStuJPanel(userProcessContainer, system);
        userProcessContainer.add("fitchallenges", fitchallenges);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    }//GEN-LAST:event_fitnesschallengeActionPerformed
    ...
    private javax.swing.JButton fitLearnings;
    private javax.swing.JButton fitnesschallenge;
