...
import Business.Organization.OrgWeightTraining;
...
public class WeightTrainerJPanel extends javax.swing.JPanel {
    ...
    WeightTrainerJPanel(JPanel userProcessContainer, EcoSystem system, NetworkLocation network, UserAccount userAccount) {
        initComponents();
    ...
    private void populateWeightStatusTable() {
        ...
        for (Organization organization : e.getOrganizationDirectory().getOrganizationList()) {
            if (organization instanceof OrgWeightTraining) {
                org = organization;
                break;
            }
        }
    ...
    private void initComponents() {
        ...
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 170, 170, 60));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 170, 340, 60));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 260, 180, 48));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 330, 820, 120));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fitlogo.jpeg"))); // NOI18N
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(-40, -30, 220, 180));

        enterpriseLabel.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        enterpriseLabel.setForeground(new java.awt.Color(0, 102, 102));
        enterpriseLabel.setText("Strength Trainer");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 50, 270, 30));
