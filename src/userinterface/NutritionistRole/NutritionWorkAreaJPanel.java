...
public class NutritionWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public NutritionWorkAreaJPanel(JPanel userProcessContainer, Enterprise enterprise, Organization organization, UserAccount account, EcoSystem business, NetworkLocation network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 140, 675, 110));

        processBtn.setBackground(new java.awt.Color(0, 102, 102));
        ...
        add(processBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 600, 179, 45));

        nameTxt.setEditable(false);
        nameTxt.setBackground(new java.awt.Color(255, 255, 255));
        nameTxt.setFont(new java.awt.Font("SansSerif", 0, 11)); // NOI18N
        add(nameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 380, 150, 30));

        jLabel2.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("Name:");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 380, 107, 30));

        txtHeight.setEditable(false);
        txtHeight.setBackground(new java.awt.Color(255, 255, 255));
        add(txtHeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 460, 150, 30));

        jLabel8.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Weight (in Kgs):");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 500, -1, 30));

        txtWeight.setEditable(false);
        txtWeight.setBackground(new java.awt.Color(255, 255, 255));
        add(txtWeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 500, 150, 30));

        jLabel5.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Age:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 420, 90, 30));

        txtAge.setEditable(false);
        txtAge.setBackground(new java.awt.Color(255, 255, 255));
        add(txtAge, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 420, 150, 30));

        jLabel7.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText("Height(in cms):");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 460, 86, 30));
        ...
        add(viewDetailsBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 280, 138, 45));

        jLabel3.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel3.setText("Message:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 350, -1, 70));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 400, -1, -1));

        jLabel4.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText("Diet Chart:");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 510, 80, 30));
        ...
        add(dietChartComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 540, 150, 30));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/images/fitlogo.jpeg"))); // NOI18N
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 80, 240, 140));
        ...
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 90, 410, 30));

        viewGoalBtn.setBackground(new java.awt.Color(0, 102, 102));
        viewGoalBtn.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        viewGoalBtn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        add(viewGoalBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 280, 138, 45));
